...
const dataURL = "https://dev-cs55-13-kc-test-site.pantheonsite.io/wp-json/twentytwentythree-child/v1/latest-posts/1";
...
//function returns names and ids for all json objects in array, sorted by name property
export async function getNewSortedList() {
  //get filepath to json file
  const filePath = path.join(dataDir, 'dessertList.json');
...
// function returns ids for all json objects in array
export async function getNewAllIds() {
  // get filepath to json file
  //const filePath = path.join(dataDir, 'dessertList.json');
...
export async function getNewData(idRequested) {
  // get filepath to json file
  //const filePath = path.join(dataDir, 'dessertList.json');
